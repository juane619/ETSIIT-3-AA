...
#Como se ve en la grafica, las variables son dependientes unas de otra, por tanto, hay que quitar una de ellas. Decidimos eliminar "angle attack".
...
# features_train = apply(features_train,2,normalized)
# features_test = apply(features_test,2,normalized)
# datos[,-5]=apply(datos[,-5], 2, normalized)

# http://www.datasciencedude.com/2015/05/31/test/

# ACLARACIONES NORMALIZACION
