...
train[,-65]=apply(train[,-65],2,normalized)
```
...
sprintf("El error dentro de la muestra (Eout) es %s", (length(aciertos_train[aciertos_train==F]) / length(aciertos_train)) * 100)
...
recomendacion: usar lo del litozz para hacer CV y asi poder comparar, debe de salir que no MEJORA nada a regresion lineal simple.
